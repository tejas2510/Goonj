.class public Landroid/support/v4/media/MediaBrowserCompat$i$c$a;
...
.field public final synthetic f:Landroid/support/v4/media/MediaBrowserCompat$i$c;


# direct methods
.method public constructor <init>(Landroid/support/v4/media/MediaBrowserCompat$i$c;Landroid/content/ComponentName;Landroid/os/IBinder;)V
    .locals 0

    .line 1
    iput-object p1, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$a;->f:Landroid/support/v4/media/MediaBrowserCompat$i$c;

    iput-object p2, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$a;->d:Landroid/content/ComponentName;

    iput-object p3, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$a;->e:Landroid/os/IBinder;
...
.method public run()V
    ...
    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$a;->d:Landroid/content/ComponentName;
    ...
    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$a;->e:Landroid/os/IBinder;
    ...
    .line 3
    iget-object v2, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$a;->f:Landroid/support/v4/media/MediaBrowserCompat$i$c;

    iget-object v2, v2, Landroid/support/v4/media/MediaBrowserCompat$i$c;->a:Landroid/support/v4/media/MediaBrowserCompat$i;

    invoke-virtual {v2}, Landroid/support/v4/media/MediaBrowserCompat$i;->f()V
    ...
    iget-object v4, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$a;->e:Landroid/os/IBinder;
    ...
    iget-object v4, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$a;->f:Landroid/support/v4/media/MediaBrowserCompat$i$c;
    ...
    .line 10
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$a;->f:Landroid/support/v4/media/MediaBrowserCompat$i$c;

    iget-object v0, v0, Landroid/support/v4/media/MediaBrowserCompat$i$c;->a:Landroid/support/v4/media/MediaBrowserCompat$i;

    invoke-virtual {v0}, Landroid/support/v4/media/MediaBrowserCompat$i;->f()V
    ...
    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$a;->f:Landroid/support/v4/media/MediaBrowserCompat$i$c;

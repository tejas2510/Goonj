...
.field public i:Landroid/support/v4/media/MediaBrowserCompat$k;
...
.method public constructor <init>(Landroid/content/Context;Landroid/content/ComponentName;Landroid/support/v4/media/MediaBrowserCompat$c;Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->e:Landroid/support/v4/media/MediaBrowserCompat$b;
    ...
    iput-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->f:Lc/e/a;
    ...
    .line 7
    iput-object p3, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->c:Landroid/support/v4/media/MediaBrowserCompat$c;
...
.method public a(Landroid/os/Messenger;)V
    ...
    .line 2
    invoke-virtual {p0, p1, v0}, Landroid/support/v4/media/MediaBrowserCompat$i;->k(Landroid/os/Messenger;Ljava/lang/String;)Z
    ...
    invoke-static {v0}, Landroid/support/v4/media/MediaBrowserCompat$i;->i(I)Ljava/lang/String;
    ...
    .line 5
    :cond_1
    invoke-virtual {p0}, Landroid/support/v4/media/MediaBrowserCompat$i;->g()V

    .line 6
    iget-object p1, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->c:Landroid/support/v4/media/MediaBrowserCompat$c;
...
.method public c()V
    ...
    .line 2
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->e:Landroid/support/v4/media/MediaBrowserCompat$b;
...
.method public d()V
    ...
    .line 3
    invoke-static {v2}, Landroid/support/v4/media/MediaBrowserCompat$i;->i(I)Ljava/lang/String;
...
.method public e(Landroid/os/Messenger;Ljava/lang/String;Landroid/support/v4/media/session/MediaSessionCompat$Token;Landroid/os/Bundle;)V
    ...
    invoke-static {p2}, Landroid/support/v4/media/MediaBrowserCompat$i;->i(I)Ljava/lang/String;
    ...
    .line 10
    invoke-virtual {p0}, Landroid/support/v4/media/MediaBrowserCompat$i;->f()V
    ...
    .line 12
    :try_start_0
    iget-object p1, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->f:Lc/e/a;

    invoke-virtual {p1}, Lc/e/a;->entrySet()Ljava/util/Set;
    ...
    .line 18
    iget-object v2, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->i:Landroid/support/v4/media/MediaBrowserCompat$k;
...
.method public f()V
    ...
    iget-object v2, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->c:Landroid/support/v4/media/MediaBrowserCompat$c;
...
.method public g()V
    ...
    .line 5
    iput-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->i:Landroid/support/v4/media/MediaBrowserCompat$k;

    .line 6
    iput-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->j:Landroid/os/Messenger;

    .line 7
    iget-object v1, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->e:Landroid/support/v4/media/MediaBrowserCompat$b;
...
.method public h(Landroid/os/Messenger;Ljava/lang/String;Ljava/util/List;Landroid/os/Bundle;Landroid/os/Bundle;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    :cond_1
    iget-object v1, p0, Landroid/support/v4/media/MediaBrowserCompat$i;->f:Lc/e/a;

    invoke-virtual {v1, p2}, Lc/e/g;->get(Ljava/lang/Object;)Ljava/lang/Object;

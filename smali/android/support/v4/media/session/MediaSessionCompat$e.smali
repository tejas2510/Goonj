...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Lc/x/d;Landroid/os/Bundle;)V
    ...
    .line 1
    invoke-direct/range {p0 .. p6}, Landroid/support/v4/media/session/MediaSessionCompat$d;-><init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Lc/x/d;Landroid/os/Bundle;)V
...
.method public m(Landroid/support/v4/media/session/MediaSessionCompat$b;Landroid/os/Handler;)V
    ...
    .line 1
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$d;->m(Landroid/support/v4/media/session/MediaSessionCompat$b;Landroid/os/Handler;)V
...
.method public v(Landroid/os/Bundle;)Landroid/media/RemoteControlClient$MetadataEditor;
    ...
    .line 1
    invoke-super {p0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$j;->v(Landroid/os/Bundle;)Landroid/media/RemoteControlClient$MetadataEditor;
...
.method public y(J)I
    ...
    .line 1
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$d;->y(J)I

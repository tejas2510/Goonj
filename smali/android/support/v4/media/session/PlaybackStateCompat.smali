...
.field public o:Landroid/media/session/PlaybackState;
...
.method public static a(Ljava/lang/Object;)Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    .line 19
    iput-object v1, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->o:Landroid/media/session/PlaybackState;
...
.method public e()Ljava/lang/Object;
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->o:Landroid/media/session/PlaybackState;
    ...
    .line 3
    iget v3, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->d:I

    iget-wide v4, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->e:J

    iget v6, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->g:F

    iget-wide v7, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->k:J
    ...
    .line 12
    iget-object v1, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->n:Landroid/os/Bundle;
    ...
    iput-object v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->o:Landroid/media/session/PlaybackState;

...
.field public g:Landroid/support/v4/media/MediaBrowserCompat$k;
...
.method public constructor <init>(Landroid/content/Context;Landroid/content/ComponentName;Landroid/support/v4/media/MediaBrowserCompat$c;Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$f;->d:Landroid/support/v4/media/MediaBrowserCompat$b;
    ...
    iput-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$f;->e:Lc/e/a;
...
.method public c()V
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$f;->g:Landroid/support/v4/media/MediaBrowserCompat$k;
    ...
    .line 2
    :try_start_0
    invoke-virtual {v0, v1}, Landroid/support/v4/media/MediaBrowserCompat$k;->f(Landroid/os/Messenger;)V
    :try_end_0
...
.method public f()V
    ...
    .line 3
    invoke-static {v1, v2}, Lc/f/h/d;->a(Landroid/os/Bundle;Ljava/lang/String;)Landroid/os/IBinder;
    ...
    invoke-direct {v3, v2, v4}, Landroid/support/v4/media/MediaBrowserCompat$k;-><init>(Landroid/os/IBinder;Landroid/os/Bundle;)V

    iput-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$f;->g:Landroid/support/v4/media/MediaBrowserCompat$k;

    .line 5
    new-instance v2, Landroid/os/Messenger;

    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$f;->d:Landroid/support/v4/media/MediaBrowserCompat$b;
    ...
    .line 7
    :try_start_1
    iget-object v2, p0, Landroid/support/v4/media/MediaBrowserCompat$f;->g:Landroid/support/v4/media/MediaBrowserCompat$k;
    ...
    invoke-virtual {v2, v3, v4}, Landroid/support/v4/media/MediaBrowserCompat$k;->d(Landroid/content/Context;Landroid/os/Messenger;)V
    :try_end_1
    ...
    .line 9
    invoke-static {v1, v0}, Lc/f/h/d;->a(Landroid/os/Bundle;Ljava/lang/String;)Landroid/os/IBinder;

    move-result-object v0

    .line 10
    invoke-static {v0}, Lb/b/b/a/a/b$a;->r(Landroid/os/IBinder;)Lb/b/b/a/a/b;
    ...
    .line 13
    invoke-static {v1, v0}, Landroid/support/v4/media/session/MediaSessionCompat$Token;->c(Ljava/lang/Object;Lb/b/b/a/a/b;)Landroid/support/v4/media/session/MediaSessionCompat$Token;
...
.method public h(Landroid/os/Messenger;Ljava/lang/String;Ljava/util/List;Landroid/os/Bundle;Landroid/os/Bundle;)V
    ...
    .line 2
    :cond_0
    iget-object p1, p0, Landroid/support/v4/media/MediaBrowserCompat$f;->e:Lc/e/a;

    invoke-virtual {p1, p2}, Lc/e/g;->get(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public i()V
    ...
    .line 1
    iput-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$f;->g:Landroid/support/v4/media/MediaBrowserCompat$k;
    ...
    .line 4
    iget-object v1, p0, Landroid/support/v4/media/MediaBrowserCompat$f;->d:Landroid/support/v4/media/MediaBrowserCompat$b;

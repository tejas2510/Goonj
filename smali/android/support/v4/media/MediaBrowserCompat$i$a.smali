...
# instance fields
.field public final synthetic d:Landroid/support/v4/media/MediaBrowserCompat$i;
...
.method public constructor <init>(Landroid/support/v4/media/MediaBrowserCompat$i;)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/v4/media/MediaBrowserCompat$i$a;->d:Landroid/support/v4/media/MediaBrowserCompat$i;
...
.method public run()V
    ...
    .line 1
    iget-object v1, p0, Landroid/support/v4/media/MediaBrowserCompat$i$a;->d:Landroid/support/v4/media/MediaBrowserCompat$i;
    ...
    iget-object v2, p0, Landroid/support/v4/media/MediaBrowserCompat$i$a;->d:Landroid/support/v4/media/MediaBrowserCompat$i;
    ...
    :cond_2
    :goto_0
    iget-object v2, v1, Landroid/support/v4/media/MediaBrowserCompat$i;->i:Landroid/support/v4/media/MediaBrowserCompat$k;
    ...
    .line 11
    :try_start_0
    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$i$a;->d:Landroid/support/v4/media/MediaBrowserCompat$i;
    ...
    invoke-virtual {v1}, Landroid/support/v4/media/MediaBrowserCompat$i;->g()V

    .line 14
    iget-object v1, p0, Landroid/support/v4/media/MediaBrowserCompat$i$a;->d:Landroid/support/v4/media/MediaBrowserCompat$i;

    iget-object v1, v1, Landroid/support/v4/media/MediaBrowserCompat$i;->c:Landroid/support/v4/media/MediaBrowserCompat$c;
    ...
    .line 17
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$i$a;->d:Landroid/support/v4/media/MediaBrowserCompat$i;
    ...
    iget-object v2, v2, Landroid/support/v4/media/MediaBrowserCompat$i;->i:Landroid/support/v4/media/MediaBrowserCompat$k;

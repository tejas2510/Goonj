...
.field public final c:Lc/f/h/i$d;
...
# direct methods
.method public constructor <init>(Lc/f/h/i$d;)V
    .locals 13
    ...
    iput-object v0, p0, Lc/f/h/j;->f:Ljava/util/List;
    ...
    iput-object v0, p0, Lc/f/h/j;->g:Landroid/os/Bundle;

    .line 4
    iput-object p1, p0, Lc/f/h/j;->c:Lc/f/h/i$d;

    .line 5
    iget-object v0, p1, Lc/f/h/i$d;->a:Landroid/content/Context;

    iput-object v0, p0, Lc/f/h/j;->a:Landroid/content/Context;
    ...
    iget-object v3, p1, Lc/f/h/i$d;->a:Landroid/content/Context;

    iget-object v4, p1, Lc/f/h/i$d;->L:Ljava/lang/String;

    invoke-direct {v2, v3, v4}, Landroid/app/Notification$Builder;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v2, p0, Lc/f/h/j;->b:Landroid/app/Notification$Builder;
    ...
    .line 9
    :goto_0
    iget-object v2, p1, Lc/f/h/i$d;->T:Landroid/app/Notification;

    .line 10
    iget-object v3, p0, Lc/f/h/j;->b:Landroid/app/Notification$Builder;
    ...
    iget-object v5, p1, Lc/f/h/i$d;->i:Landroid/widget/RemoteViews;
    ...
    iget-object v4, p1, Lc/f/h/i$d;->e:Ljava/lang/CharSequence;
    ...
    iget-object v4, p1, Lc/f/h/i$d;->f:Ljava/lang/CharSequence;
    ...
    iget-object v4, p1, Lc/f/h/i$d;->k:Ljava/lang/CharSequence;
    ...
    iget-object v4, p1, Lc/f/h/i$d;->g:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Lc/f/h/i$d;->h:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Lc/f/h/i$d;->j:Landroid/graphics/Bitmap;
    ...
    iget v4, p1, Lc/f/h/i$d;->u:I

    iget v9, p1, Lc/f/h/i$d;->v:I

    iget-boolean v10, p1, Lc/f/h/i$d;->w:Z
    ...
    .line 29
    iget-object v4, p0, Lc/f/h/j;->b:Landroid/app/Notification$Builder;
    ...
    .line 30
    iget-object v0, p0, Lc/f/h/j;->b:Landroid/app/Notification$Builder;

    iget-object v8, p1, Lc/f/h/i$d;->r:Ljava/lang/CharSequence;
    ...
    iget-boolean v8, p1, Lc/f/h/i$d;->o:Z
    ...
    check-cast v8, Lc/f/h/i$a;

    .line 34
    invoke-virtual {p0, v8}, Lc/f/h/j;->b(Lc/f/h/i$a;)V

    goto :goto_5

    .line 35
    :cond_6
    iget-object v0, p1, Lc/f/h/i$d;->E:Landroid/os/Bundle;

    if-eqz v0, :cond_7

    .line 36
    iget-object v8, p0, Lc/f/h/j;->g:Landroid/os/Bundle;
    ...
    .line 38
    iget-boolean v0, p1, Lc/f/h/i$d;->A:Z

    if-eqz v0, :cond_8

    .line 39
    iget-object v0, p0, Lc/f/h/j;->g:Landroid/os/Bundle;
    ...
    .line 40
    :cond_8
    iget-object v0, p1, Lc/f/h/i$d;->x:Ljava/lang/String;
    ...
    .line 42
    iget-boolean v0, p1, Lc/f/h/i$d;->y:Z
    ...
    :cond_a
    :goto_6
    iget-object v0, p1, Lc/f/h/i$d;->z:Ljava/lang/String;
    ...
    .line 47
    :cond_b
    iget-object v0, p1, Lc/f/h/i$d;->I:Landroid/widget/RemoteViews;

    iput-object v0, p0, Lc/f/h/j;->d:Landroid/widget/RemoteViews;

    .line 48
    iget-object v0, p1, Lc/f/h/i$d;->J:Landroid/widget/RemoteViews;

    iput-object v0, p0, Lc/f/h/j;->e:Landroid/widget/RemoteViews;
    ...
    .line 50
    iget-object v8, p0, Lc/f/h/j;->b:Landroid/app/Notification$Builder;

    iget-boolean v9, p1, Lc/f/h/i$d;->n:Z
    ...
    .line 51
    iget-object v8, p1, Lc/f/h/i$d;->c:Ljava/util/ArrayList;

    invoke-static {v8}, Lc/f/h/j;->f(Ljava/util/List;)Ljava/util/List;

    move-result-object v8

    iget-object v9, p1, Lc/f/h/i$d;->W:Ljava/util/ArrayList;

    invoke-static {v8, v9}, Lc/f/h/j;->e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    .line 53
    iget-object v9, p0, Lc/f/h/j;->g:Landroid/os/Bundle;
    ...
    iget-boolean v8, p1, Lc/f/h/i$d;->y:Z
    ...
    iget-object v8, p1, Lc/f/h/i$d;->H:Landroid/app/Notification;
    ...
    .line 66
    iget-object v0, p1, Lc/f/h/i$d;->c:Ljava/util/ArrayList;

    invoke-static {v0}, Lc/f/h/j;->f(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    iget-object v3, p1, Lc/f/h/i$d;->W:Ljava/util/ArrayList;

    invoke-static {v0, v3}, Lc/f/h/j;->e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    .line 67
    :cond_10
    iget-object v0, p1, Lc/f/h/i$d;->W:Ljava/util/ArrayList;
    ...
    .line 71
    :cond_11
    iget-object v0, p1, Lc/f/h/i$d;->K:Landroid/widget/RemoteViews;

    iput-object v0, p0, Lc/f/h/j;->i:Landroid/widget/RemoteViews;

    .line 72
    iget-object v0, p1, Lc/f/h/i$d;->d:Ljava/util/ArrayList;
    ...
    .line 73
    invoke-virtual {p1}, Lc/f/h/i$d;->e()Landroid/os/Bundle;
    ...
    .line 77
    :goto_9
    iget-object v11, p1, Lc/f/h/i$d;->d:Ljava/util/ArrayList;
    ...
    iget-object v12, p1, Lc/f/h/i$d;->d:Ljava/util/ArrayList;
    ...
    check-cast v12, Lc/f/h/i$a;

    .line 80
    invoke-static {v12}, Lc/f/h/k;->b(Lc/f/h/i$a;)Landroid/os/Bundle;
    ...
    .line 87
    iget-object v3, p1, Lc/f/h/i$d;->V:Landroid/graphics/drawable/Icon;
    ...
    .line 91
    iget-object v3, p1, Lc/f/h/i$d;->I:Landroid/widget/RemoteViews;
    ...
    .line 93
    :cond_16
    iget-object v3, p1, Lc/f/h/i$d;->J:Landroid/widget/RemoteViews;
    ...
    .line 95
    :cond_17
    iget-object v3, p1, Lc/f/h/i$d;->K:Landroid/widget/RemoteViews;
    ...
    iget-object v9, p1, Lc/f/h/i$d;->N:Ljava/lang/String;
    ...
    iget-wide v9, p1, Lc/f/h/i$d;->P:J
    ...
    check-cast v4, Lc/f/h/m;

    .line 110
    iget-object v7, p0, Lc/f/h/j;->b:Landroid/app/Notification$Builder;

    invoke-virtual {v4}, Lc/f/h/m;->h()Landroid/app/Person;
    ...
    iget-boolean v7, p1, Lc/f/h/i$d;->R:Z
    ...
    iget-object v7, p1, Lc/f/h/i$d;->S:Lc/f/h/i$c;

    .line 114
    invoke-static {v7}, Lc/f/h/i$c;->a(Lc/f/h/i$c;)Landroid/app/Notification$BubbleMetadata;
    ...
    .line 116
    iget-object v4, p1, Lc/f/h/i$d;->O:Lc/f/i/c;
    ...
    :cond_1d
    :goto_b
    iget-boolean p1, p1, Lc/f/h/i$d;->U:Z

    if-eqz p1, :cond_20

    .line 119
    iget-object p1, p0, Lc/f/h/j;->c:Lc/f/h/i$d;

    iget-boolean p1, p1, Lc/f/h/i$d;->y:Z

    if-eqz p1, :cond_1e

    .line 120
    iput v5, p0, Lc/f/h/j;->h:I

    goto :goto_c

    .line 121
    :cond_1e
    iput v6, p0, Lc/f/h/j;->h:I

    .line 122
    :goto_c
    iget-object p1, p0, Lc/f/h/j;->b:Landroid/app/Notification$Builder;
    ...
    .line 126
    iget-object v2, p0, Lc/f/h/j;->b:Landroid/app/Notification$Builder;
    ...
    iget-object p1, p1, Lc/f/h/i$d;->x:Ljava/lang/String;
...
.method public static e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {v0, v1}, Lc/e/b;-><init>(I)V

    .line 2
    invoke-virtual {v0, p0}, Lc/e/b;->addAll(Ljava/util/Collection;)Z
...
.method public static f(Ljava/util/List;)Ljava/util/List;
    ...
    check-cast v1, Lc/f/h/m;

    .line 3
    invoke-virtual {v1}, Lc/f/h/m;->g()Ljava/lang/String;
...
.method public final b(Lc/f/h/i$a;)V
    .locals 5
    ...
    .line 2
    invoke-virtual {p1}, Lc/f/h/i$a;->f()Landroidx/core/graphics/drawable/IconCompat;
    ...
    .line 5
    :goto_0
    invoke-virtual {p1}, Lc/f/h/i$a;->j()Ljava/lang/CharSequence;

    move-result-object v2

    .line 6
    invoke-virtual {p1}, Lc/f/h/i$a;->a()Landroid/app/PendingIntent;
    ...
    .line 11
    :goto_2
    invoke-virtual {p1}, Lc/f/h/i$a;->g()[Lc/f/h/n;
    ...
    .line 13
    invoke-static {v1}, Lc/f/h/n;->b([Lc/f/h/n;)[Landroid/app/RemoteInput;
    ...
    .line 15
    :cond_3
    invoke-virtual {p1}, Lc/f/h/i$a;->d()Landroid/os/Bundle;
    ...
    .line 18
    :goto_4
    invoke-virtual {p1}, Lc/f/h/i$a;->b()Z
    ...
    .line 22
    :cond_5
    invoke-virtual {p1}, Lc/f/h/i$a;->h()I
    ...
    .line 25
    invoke-virtual {p1}, Lc/f/h/i$a;->k()Z
    ...
    .line 26
    :cond_7
    invoke-virtual {p1}, Lc/f/h/i$a;->i()Z
    ...
    .line 30
    iget-object v0, p0, Lc/f/h/j;->f:Ljava/util/List;

    iget-object v1, p0, Lc/f/h/j;->b:Landroid/app/Notification$Builder;

    .line 31
    invoke-static {v1, p1}, Lc/f/h/k;->f(Landroid/app/Notification$Builder;Lc/f/h/i$a;)Landroid/os/Bundle;
...
.method public c()Landroid/app/Notification;
    ...
    .line 1
    iget-object v0, p0, Lc/f/h/j;->c:Lc/f/h/i$d;

    iget-object v0, v0, Lc/f/h/i$d;->q:Lc/f/h/i$e;

    if-eqz v0, :cond_0

    .line 2
    invoke-virtual {v0, p0}, Lc/f/h/i$e;->b(Lc/f/h/h;)V

    :cond_0
    if-eqz v0, :cond_1

    .line 3
    invoke-virtual {v0, p0}, Lc/f/h/i$e;->j(Lc/f/h/h;)Landroid/widget/RemoteViews;
    ...
    .line 4
    :goto_0
    invoke-virtual {p0}, Lc/f/h/j;->d()Landroid/app/Notification;
    ...
    .line 6
    :cond_2
    iget-object v1, p0, Lc/f/h/j;->c:Lc/f/h/i$d;

    iget-object v1, v1, Lc/f/h/i$d;->I:Landroid/widget/RemoteViews;
    ...
    .line 9
    invoke-virtual {v0, p0}, Lc/f/h/i$e;->i(Lc/f/h/h;)Landroid/widget/RemoteViews;
    ...
    .line 11
    iget-object v4, p0, Lc/f/h/j;->c:Lc/f/h/i$d;

    iget-object v4, v4, Lc/f/h/i$d;->q:Lc/f/h/i$e;

    .line 12
    invoke-virtual {v4, p0}, Lc/f/h/i$e;->k(Lc/f/h/h;)Landroid/widget/RemoteViews;
    ...
    .line 14
    invoke-static {v2}, Lc/f/h/i;->a(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    .line 15
    invoke-virtual {v0, v1}, Lc/f/h/i$e;->a(Landroid/os/Bundle;)V
...
.method public d()Landroid/app/Notification;
    ...
    .line 6
    invoke-virtual {p0, v0}, Lc/f/h/j;->g(Landroid/app/Notification;)V
    ...
    iget-object v1, p0, Lc/f/h/j;->g:Landroid/os/Bundle;
    ...
    .line 11
    iget-object v1, p0, Lc/f/h/j;->d:Landroid/widget/RemoteViews;
    ...
    .line 13
    :cond_4
    iget-object v1, p0, Lc/f/h/j;->e:Landroid/widget/RemoteViews;
    ...
    .line 15
    :cond_5
    iget-object v1, p0, Lc/f/h/j;->i:Landroid/widget/RemoteViews;
    ...
    .line 34
    invoke-static {v0}, Lc/f/h/k;->a(Ljava/util/List;)Landroid/util/SparseArray;
    ...
    .line 43
    invoke-static {v0}, Lc/f/h/i;->a(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    iget-object v4, p0, Lc/f/h/j;->g:Landroid/os/Bundle;
    ...
    .line 49
    iget-object v1, p0, Lc/f/h/j;->f:Ljava/util/List;

    .line 50
    invoke-static {v1}, Lc/f/h/k;->a(Ljava/util/List;)Landroid/util/SparseArray;

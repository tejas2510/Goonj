...
.field public static final d:Lc/e/g;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lc/e/g<",
            "Ljava/lang/String;",
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lc/b/k/i;->a:[Ljava/lang/Class;
    ...
    sput-object v0, Lc/b/k/i;->c:[Ljava/lang/String;
    ...
    sput-object v0, Lc/b/k/i;->d:Lc/e/g;
...
.method public constructor <init>()V
    ...
    .line 2
    iput-object v0, p0, Lc/b/k/i;->e:[Ljava/lang/Object;
...
.method public static t(Landroid/content/Context;Landroid/util/AttributeSet;ZZ)Landroid/content/Context;
    ...
    .line 7
    invoke-virtual {p1}, Lc/b/p/d;->c()I
    ...
    .line 8
    :cond_2
    new-instance p1, Lc/b/p/d;

    invoke-direct {p1, p0, p2}, Lc/b/p/d;-><init>(Landroid/content/Context;I)V
...
.method public final a(Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    .line 3
    invoke-static {p1}, Lc/f/q/s;->z(Landroid/view/View;)Z
    ...
    .line 6
    new-instance v1, Lc/b/k/i$a;

    invoke-direct {v1, p1, v0}, Lc/b/k/i$a;-><init>(Landroid/view/View;Ljava/lang/String;)V
...
.method public final q(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
    ...
    .line 2
    :cond_1
    invoke-static {p1, p4, p6, p7}, Lc/b/k/i;->t(Landroid/content/Context;Landroid/util/AttributeSet;ZZ)Landroid/content/Context;
    ...
    .line 5
    invoke-virtual {p0, p1, p2, p4}, Lc/b/k/i;->p(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    .line 6
    :pswitch_0
    invoke-virtual {p0, p1, p4}, Lc/b/k/i;->c(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatButton;

    move-result-object p5

    .line 7
    invoke-virtual {p0, p5, p2}, Lc/b/k/i;->u(Landroid/view/View;Ljava/lang/String;)V

    goto/16 :goto_2

    .line 8
    :pswitch_1
    invoke-virtual {p0, p1, p4}, Lc/b/k/i;->f(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatEditText;
    ...
    .line 10
    :pswitch_2
    invoke-virtual {p0, p1, p4}, Lc/b/k/i;->d(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatCheckBox;
    ...
    .line 12
    :pswitch_3
    invoke-virtual {p0, p1, p4}, Lc/b/k/i;->b(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatAutoCompleteTextView;
    ...
    .line 14
    :pswitch_4
    invoke-virtual {p0, p1, p4}, Lc/b/k/i;->h(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatImageView;
    ...
    .line 16
    :pswitch_5
    invoke-virtual {p0, p1, p4}, Lc/b/k/i;->o(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatToggleButton;
    ...
    .line 18
    :pswitch_6
    invoke-virtual {p0, p1, p4}, Lc/b/k/i;->j(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatRadioButton;
    ...
    .line 20
    :pswitch_7
    invoke-virtual {p0, p1, p4}, Lc/b/k/i;->m(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatSpinner;
    ...
    .line 22
    :pswitch_8
    invoke-virtual {p0, p1, p4}, Lc/b/k/i;->l(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatSeekBar;
    ...
    .line 24
    :pswitch_9
    invoke-virtual {p0, p1, p4}, Lc/b/k/i;->g(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatImageButton;
    ...
    .line 26
    :pswitch_a
    invoke-virtual {p0, p1, p4}, Lc/b/k/i;->n(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatTextView;
    ...
    .line 28
    :pswitch_b
    invoke-virtual {p0, p1, p4}, Lc/b/k/i;->i(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatMultiAutoCompleteTextView;
    ...
    .line 30
    :pswitch_c
    invoke-virtual {p0, p1, p4}, Lc/b/k/i;->e(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatCheckedTextView;
    ...
    .line 32
    :pswitch_d
    invoke-virtual {p0, p1, p4}, Lc/b/k/i;->k(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatRatingBar;
    ...
    .line 34
    invoke-virtual {p0, p1, p2, p4}, Lc/b/k/i;->s(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    .line 35
    invoke-virtual {p0, p5, p4}, Lc/b/k/i;->a(Landroid/view/View;Landroid/util/AttributeSet;)V
...
.method public final r(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    .line 1
    sget-object v0, Lc/b/k/i;->d:Lc/e/g;

    invoke-virtual {v0, p2}, Lc/e/g;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 6
    sget-object p3, Lc/b/k/i;->a:[Ljava/lang/Class;
    ...
    .line 7
    invoke-virtual {v0, p2, v1}, Lc/e/g;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 9
    iget-object p1, p0, Lc/b/k/i;->e:[Ljava/lang/Object;
...
.method public final s(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    .line 3
    :try_start_0
    iget-object v3, p0, Lc/b/k/i;->e:[Ljava/lang/Object;
    ...
    .line 6
    :goto_0
    sget-object v3, Lc/b/k/i;->c:[Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, p2, v3}, Lc/b/k/i;->r(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    :cond_3
    :try_start_1
    invoke-virtual {p0, p1, p2, v1}, Lc/b/k/i;->r(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    .line 13
    iget-object p2, p0, Lc/b/k/i;->e:[Ljava/lang/Object;
